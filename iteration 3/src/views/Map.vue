      ...
      <div class="chart-container">
        ...
        <div class="chart-text-content">
          ...
          <p class="chart-description">
            Melbourne's Urban Forest Strategy (2012–2024) promotes native, climate-resilient trees like Eucalyptus 
            from the Myrtaceae family to enhance canopy cover and biodiversity.
            Their ability to thrive in heat, pollution and compacted soils makes them common across the city and 
            make Myrtaceae valuable for ecology and a key pollen source for hay fever in Melbourne.
          </p>
        </div>
