<template>
  <div id="app">
    ...
    <main class="main-content">
        ...
        <PlayGame v-else-if="currentView === 'game'" />
...
export default {
  ...
  data() {
    return {
      ...
      navItems: [
        ...
        { id: 'image', text: 'Plant Detection', href: '#image' },
        { id: 'game', text: 'Play Game', href: '#game' },
  ...
  methods: {
    ...
    // params: id - feature id from HomePage ('tracker'|'education'|'plant-identifier'|'map'|'challenge'|'support')
    ...
    handleHashChange() {
      ...
      const validViews = ['home', 'dashboard', 'map', 'image', 'game', 'resources', 'support', 'symptoms'];
